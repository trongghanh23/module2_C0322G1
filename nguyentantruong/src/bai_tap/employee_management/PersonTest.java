...
public class PersonTest {
    ...
    static {
        personList[0] = new Student(1, "an", 20, true, 10);
        personList[1] = new Teacher(2, "hải", 29, false, 1000000);
        personList[2] = new Student(3, "ngọc", 19, true, 9);
        personList[3] = new Teacher(4, "mỹ", 35, false, 2000000);
        personList[4] = new Student(5, "Tâm", 27, true, 8);
        count = 5;
    }
